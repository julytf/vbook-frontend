...
function Cart() {
  useLayoutEffect(() => {
    document.querySelector("body").classList =
      "page-template-default page page-id-998 wp-custom-logo theme-astra woocommerce-cart woocommerce-page woocommerce-js ast-desktop ast-plain-container ast-no-sidebar astra-4.0.2 ast-single-post ast-inherit-site-logo-transparent ast-hfb-header ast-normal-title-enabled elementor-default elementor-kit-1345";
  }, []);
  return (
              ...
              <div className="entry-content clear" itemProp="text">
                <div className="woocommerce">
                  ...
                  <form
                    ...
                    action="https://websitedemos.net/earth-store-02/cart/"
                    method="post"
                  >
                    <table
                        ...
                        <tr className="woocommerce-cart-form__cart-item cart_item">
                          ...
                          <td className="product-thumbnail">
                            <a href="https://websitedemos.net/earth-store-02/product/poster-v2/">
                              <img
                                width={1000}
                                height={1000}
                                src="./Cart - Planet Earth Store_files/Poster6-1000x1000.jpg"
                          ...
                          >
                            <div className="quantity buttons_added">
                              ...
                              <label
                                className="screen-reader-text"
                                htmlFor="quantity_642048807a336"
                              >
                                Poster V2 quantity
                              </label>
                              <input
                                type="number"
                                id="quantity_642048807a336"
                                className="input-text qty text"
                                name="cart[801c14f07f9724229175b8ef8b4585a8][qty]"
                                defaultValue={1}
                                title="Qty"
                                size={4}
                                min={0}
                        ...
                        <tr>
                          <td colSpan={6} className="actions">
                            ...
                            <input
                              ...
                              defaultValue="/earth-store-02/cart/"
                            />
                          </td>
                        </tr>
                      </tbody>
