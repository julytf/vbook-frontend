              ...
              <div className="ast-woocommerce-container">
                ...
                >
                  ...
                  <div className="summary entry-summary">
                    ...
                    <form
                      className="cart"
                      action="https://websitedemos.net/earth-store-02/product/postcard-v2/"
                      method="post"
                    ...
                    >
                      <div className="quantity buttons_added">
                        ...
                        <a href="javascript:void(0)" id="minus_qty" className="minus">
                          -
                        </a>
                        ...
                        <a href="javascript:void(0)" id="plus_qty" className="plus">
                          +
                        </a>
                      </div>
                      <button
                      ...
                      <div className="ProductDescription-attributeValueInfo">
                        <div className="ProductDescription-attributeValueDescription">
                          <ul>
                            ...
                            <li><b>NXB:</b> {book.publisher}</li>
                            <li><b>Ngôn Ngữ:</b> {book.language}</li>
                            <li><b>Trọng lượng (gr):</b> {book.weight}</li>
                            <li><b>Kích Thước Bao Bì:</b> {book.form}</li>
                            <li><b>Số trang:</b> {book.noPage}</li>
                            <li><b>Hình thức:</b> {book.form}</li>
                          </ul>
                          {/* <p className="ProductDescription-attributeHeader">
